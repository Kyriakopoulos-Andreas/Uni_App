...
// *
// * <p>
// * Η κλάση είναι αποσυνδεδεμένη από το UI και διαθέτει μία μέθοδο που δέχεται μια λίστα αντικειμένων {@link com.eapproject.DomainLayer.Models.UniversityModel}
