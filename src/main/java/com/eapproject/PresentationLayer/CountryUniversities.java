...
public class CountryUniversities extends javax.swing.JPanel {
    ...
    public CountryUniversities(String countryLogo, JPanel rightScreenPanel, ArrayList<University> universities, UniversitiesViewModel viewModel, List<University> allUniversities) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        for (int i = 0; i < universitiesFromSpecificCountry.size(); i++) {
            ...
            universitiesData[i][1] = universitiesFromSpecificCountry.get(i).getName(); // University name
        }
