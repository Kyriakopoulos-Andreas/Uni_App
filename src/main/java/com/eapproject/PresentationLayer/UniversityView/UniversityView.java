...
public class UniversityView extends javax.swing.JPanel {
    ...
    public UniversityView(University university, UniversitiesViewModel viewModel) {
...
//    }
    ...
    private void saveTodoData() {
        // Ενημερώνουμε το αντικείμενο University με τις νέες τιμές
        ...
        // Στέλνουμε τις αλλαγές στο ViewModel
        viewModel.updateExtendUniversity(university);

        // Αντιγράφουμε τα δεδομένα από Edit -> View
