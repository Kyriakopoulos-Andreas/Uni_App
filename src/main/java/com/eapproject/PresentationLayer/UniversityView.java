...
//    }
    ...
    private void saveTodoData() {
        ...
        SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
            ...
            @Override
            protected void done() {
                // Όταν ολοκληρωθεί η διαδικασία, ελέγχουμε την τιμή της availabilityOfCountryUpdate.
                if (viewModel.getAvailabilityOfCountryUpdate()) {
                    // Εάν είναι διαθέσιμη η χώρα, προχωράμε με την αποθήκευση των δεδομένων.
                    ...
                    updateButton.setText("Save Changes");
                    JOptionPane.showMessageDialog(null, "The country entered does not exist. Please provide a valid value.",
        ...
        // Εκκινήστε τον worker στο παρασκήνιο
        worker.execute();
    }
